...
<template>
  <main>
    <h2>Gallery</h2>
    <p>
      Open this project on your phone, and notice how we cannot swipe between
      slides or scroll the page from within the Slider/3D preview.
    </p>
      ...
      <SwiperSlide>
        <div class="viewer-shell">
          <iframe
            ...
            :webkitallowfullscreen="true"
          ></iframe>
          <div class="viewer-scroll-zone viewer-scroll-zone--top"></div>
          <div class="viewer-scroll-zone viewer-scroll-zone--bottom"></div>
        </div>
      </SwiperSlide>
